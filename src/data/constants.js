import newtonSchool from './../images/newtonSchool.jpeg';
import smartworks from './../images/logo.png';
export const Bio = {
...
export const skills = [
  {
    ...
    skills: [
      ...
      {
        name: "Tailwind CSS",
        image: " data:image/jpeg;base64,",
      },
      {
        name: "Shadcn UI",
        image:
...
export const experiences = [
  {
    ...
    desc: "Spearheaded the development of a scalable ERP system using React.js and Redux, reducing business process automation time by 20%. Delivered 10+ UI modules for streamlined workflows, integrated Excel export, and automated IoT-based monitoring, boosting efficiency. Enhanced data accuracy with Formik and Yup and optimized performance with Redux Saga, securing sensitive features and enabling seamless Agile delivery of 15+ features.",
    skills:['ReactJS',"NextJS",'Redux','Zustand',"HTML",
      "CSS",
      "JavaScript",
      "API Integration",
      "Bootstrap",
      'TypeScript','Tailwind CSS', 'UI/UX','Responsive Design' ,'Webpack', 'Vite', 'API','Git','Agile','Node.js'
    ]
  },
